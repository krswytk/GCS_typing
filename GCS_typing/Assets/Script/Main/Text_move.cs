...
public class Text_move : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (sw==false)
        {
            ...
            if (Lenth[Line] % 2 == 0)
            {
                add.x = -5.13f - (((Lenth[Line]) / 2) * 0.24f);
                pos.x = -5.13f - (((Lenth[Line]) / 2) * 0.24f);
                Debug.Log("Lenth[Line] % 2 == 0");
            }
            else
            {
                add.x = -5.3f - (((Lenth[Line] - 1) / 2) * 0.24f);
                pos.x = -5.3f - (((Lenth[Line] - 1) / 2) * 0.24f);
        ...
        Debug.Log(myTransform.position.x);//17文字 7.22  7文字  6.02
    }
}